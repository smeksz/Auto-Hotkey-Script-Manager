...
import main, subprocess, time, os, importlib, pickle, webbrowser
...
# images
edit_image_c = Image.open("assets\\edit.png").resize((20,20), Image.Resampling.LANCZOS)
edit_image = ImageTk.PhotoImage(edit_image_c)
restart_image_c = Image.open("assets\\restart.png").resize((20,20), Image.Resampling.LANCZOS)
restart_image = ImageTk.PhotoImage(restart_image_c)
stop_process_image_c = Image.open("assets\\stop_process.png").resize((20,20), Image.Resampling.LANCZOS)
stop_process_image = ImageTk.PhotoImage(stop_process_image_c)
settings_image_c = Image.open("assets\\settings.png").resize((20,20), Image.Resampling.LANCZOS)
settings_image = ImageTk.PhotoImage(settings_image_c)
run_image_c = Image.open("assets\\run.png").resize((20,20), Image.Resampling.LANCZOS)
run_image = ImageTk.PhotoImage(run_image_c)
file_dialog_image_c = Image.open("assets\\file_dialog.png").resize((20,20), Image.Resampling.LANCZOS)
